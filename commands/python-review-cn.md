---
description: 全面的 Python 代码审查，检查 PEP 8 合规性、类型提示、安全性和 Pythonic 惯用写法。调用 python-reviewer 代理。
---

# Python 代码审查

此命令调用 **python-reviewer** 代理进行 Python 专用的全面代码审查。
